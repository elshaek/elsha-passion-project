...
get '/requestinfo' do
  ...
  content_type :json
  { total_dice_supply: @total_dice_supply, quarterly_profits_eth: @quarterly_profits_eth, eth_rate: @eth_rate, dice_rate_eth: @dice_rate_eth, dice_rate_usd: @dice_rate_usd }.to_json
end